...
class RideCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final primaryThemeColor = isCaptainView ? const Color(0xFF2E7D32) : const Color(0xFF1A237E);
    final secondaryAccent = isCaptainView ? const Color(0xFF81C784) : const Color(0xFF3F51B5);
    final routeColor = const Color(0xFF1E293B);
