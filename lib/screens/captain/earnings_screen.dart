...
class _EarningsScreenState extends State<EarningsScreen> {
  ...
  Future<void> _loadData() async {
    try {
      ...
      setState(() {
        _weekData = List<double>.from(summary['weekData'] ?? [0, 0, 0, 0, 0, 0, 0]);
                              ...
                              return GestureDetector(
                                ...
                                child: AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(color: sel ? AppColors.primary : AppColors.light, width: 1),
                                  ),
                                  child: Text(
                                    p[0].toUpperCase() + p.substring(1),
                                    style: TextStyle(
                                      color:      sel ? AppColors.white : AppColors.textMuted,
                                      fontSize:   13,
                                      fontWeight: FontWeight.w800,
                                    ),
                                  ),
                                            ...
                                            decoration: BoxDecoration(
                                              gradient: LinearGradient(
                                                colors: i == 5 
                                                  ...
                                                  : [AppColors.light, AppColors.light.withOpacity(0.5)],
                      ...
                      : _transactions.isEmpty
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, i) {
                                ...
                                final isDebit = tx['type'] == 'commission_deduction';
                                ...
                                return Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(color: AppColors.light, width: 0.5),
                                  ),
                                  child: Row(
                                    children: [
                                      Container(
                                        ...
                                        child: Icon(isDebit ? Icons.remove_circle_outline : Icons.add_circle_outline, color: AppColors.primary, size: 18),
                                      ),
                                      const SizedBox(width: 14),
                                      Expanded(
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text(tx['description'] ?? tx['type'] ?? 'Transaction', style: const TextStyle(color: AppColors.textDark, fontWeight: FontWeight.w700, fontSize: 14)),
                                            Text(date.length > 10 ? date.substring(0, 10) : date, style: const TextStyle(color: AppColors.textMuted, fontSize: 11)),
                                          ],
                                        ),
                                      ),
                                      Text('${isDebit ? '-' : '+'}Rs ${amount.toStringAsFixed(0)}', style: TextStyle(color: isDebit ? Colors.red : const Color(0xFF4A7C59), fontWeight: FontWeight.w800, fontSize: 14)),
                                    ],
                                  ),
                                );
                              },
