                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            // ✅ A captain who switches their account to
                            // "Passenger" mode used to lose all access to
                            // rides they had already posted — the app only
                            // ever showed the captain-only screens while
                            // role == 'captain'. This entry stays reachable
                            // in passenger mode too, so a previously-posted
                            // ride is still visible and its requests can
                            // still be accepted.
                            if (user?.role != 'captain')
                              _ProfileMenuItem(
                                icon: Icons.directions_car_filled_rounded,
