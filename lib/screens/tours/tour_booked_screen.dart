          ...
          SafeArea(
            child: Column(
              children: [
                ...
                const Text('Tour Booked!', style: TextStyle(fontSize: 32, fontWeight: FontWeight.w900, color: AppColors.textDark)),
                ...
                const Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(color: AppColors.textMuted, fontSize: 16, height: 1.6, fontWeight: FontWeight.w500),
                  ),
                ),
