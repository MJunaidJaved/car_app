...
class TourDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final dateStr = DateFormat('EEE, d MMM · h:mm a').format(dt);
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                  colors: [AppColors.dark, Color(0xFF414833)],
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Text('Tour Details', style: TextStyle(color: AppColors.white, fontSize: 20, fontWeight: FontWeight.w800)),
                    ],
                  ),
                ),
                Expanded(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: const Center(
                            child: Icon(Icons.landscape_rounded, size: 72, color: AppColors.primary),
                          ),
                        ),
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () => Navigator.pushNamed(context, '/fare-negotiate', arguments: ride),
                            ...
                            child: const Text('Request to Join', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 16)),
                          ),
                        ),
                      ],
                    ),
