                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              _TaglineWord(text: 'SAVE FUEL'),
                              _TaglineDot(),
                              _TaglineWord(text: 'SHARE RIDES'),
                              _TaglineDot(),
                              _TaglineWord(text: 'EARN'),
                            ],
                          ),
                        ],
                      ),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            const _FeatureRow(
                              icon: Icons.check_circle_outline_rounded,
                              text: 'Trusted & verified captains',
                              delayMs: 150,
                            ),
                            const SizedBox(height: 14),
                            const _FeatureRow(
                              icon: Icons.check_circle_outline_rounded,
                              text: 'Fair, flexible fares',
                              delayMs: 300,
                            ),
                            const Spacer(),
                            ScaleTransition(
...
class _TaglineWord extends StatelessWidget {
  final String text;
  const _TaglineWord({required this.text});
      ...
      child: Row(
        ...
        children: [
          Icon(Icons.check_circle_rounded,
              color: AppColors.skyBlue.withValues(alpha: 0.95), size: 17),
