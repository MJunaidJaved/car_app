                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                            ...
                            if (mounted) {
                              ...
                              if (userProvider.user != null) {
                                final updatedUser = userProvider.user?.copyWith(
                                  role: userData['role'],
                                  captainVerificationStatus: userData['captainVerificationStatus'],
                          ...
                          if (mounted) {
                            // Navigate to home screen (handles captain/passenger routing)
...
class _ConfettiPieceState extends State<_ConfettiPiece> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _color = [AppColors.primary, AppColors.dark, AppColors.accent, AppColors.light][random.nextInt(4)];
