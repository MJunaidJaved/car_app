        ...
        SafeArea(
          child: Column(
            ...
            children: [
              ...
              // Search card (simplified: only From, To and Search)
              Padding(
...
class _RideResultCardState extends State<_RideResultCard>
  ...
  Widget build(BuildContext context) {
    ...
    final vehicleGradient = AppColors.vehicleGradient(widget.ride.vehicleType);
    ...
    return ScaleTransition(
      ...
      child: FadeTransition(
        ...
        child: GestureDetector(
          onTap: () {
            // Optional: expand/preview action
          },
          child: Container(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Icon(
                        _vehicleIcon(widget.ride.vehicleType),
                        color: Colors.white,
                        size: 24,
                      ),
                      const SizedBox(width: 8),
                ...
                if ((widget.ride.vehiclePhotoUrl ?? '').trim().isNotEmpty) ...[
                  ClipRRect(
                    borderRadius: const BorderRadius.only(
                      topLeft: Radius.circular(22),
                      topRight: Radius.circular(22),
                    ...
                    child: Container(
                      ...
                      color: AppColors.surfaceBlue,
                      child: CachedNetworkImage(
                        imageUrl: widget.ride.vehiclePhotoUrl!.trim(),
                        fit: BoxFit.cover,
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          gradient: LinearGradient(
                            colors: [
                              vehicleColor.withValues(alpha: 0.08),
  ...
  IconData _vehicleIcon(String vehicleType) {
    return switch (vehicleType.toLowerCase().trim()) {
      'bike' => Icons.two_wheeler,
      'bus' => Icons.directions_bus,
      'truck' => Icons.local_shipping,
      'shazore' => Icons.local_shipping,
