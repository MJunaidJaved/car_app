...
class _FindRideScreenState extends State<FindRideScreen>
  ...
  // ── Helpers ───────────────────────────────
  double _dist(double aLat, double aLng, double bLat, double bLng) {
    return AppHelpers.distanceKm(aLat, aLng, bLat, bLng);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _mapMode ? _buildMapView(isFemale) : _buildListView(isFemale),
    );
  }
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              _Chip(Icons.directions_car_outlined, ride.vehicleType),
              const Spacer(),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
              color: AppColors.bark.withValues(alpha:0.03),
              blurRadius: 15,
