...
class RideModel {
  ...
  factory RideModel.fromMap(Map<String, dynamic> data, String id) {
    return RideModel(
      ...
      departureDisplay:
          (data['departureDisplay'] ?? data['displayDateTime'])?.toString(),
  ...
  Map<String, dynamic> toMap({bool forFirestore = false}) {
    return {
      ...
      'isProximityMatch': isProximityMatch,
  ...
  RideModel copyWith({
    ...
    return RideModel(
      ...
      departureDisplay: departureDisplay ?? this.departureDisplay,
      routeDisplay: routeDisplay ?? this.routeDisplay,
      captainRating: captainRating ?? this.captainRating,
      createdAt: createdAt ?? this.createdAt,
      isProximityMatch: isProximityMatch ?? this.isProximityMatch,
